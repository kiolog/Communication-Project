...
namespace FileMessage
{
    public partial class FileMessageBox : UserControl
    {
        ...
        public FileMessageBox(int _iID, TalkClient.DelInsertToQueue _CallBack,int _iOwnerID,int _iRoomID)
        {
            InitializeComponent();
            m_iID = _iID;
        ...
        public void MessageBox_Click(object sender, EventArgs e)
        {
            ...
            ListSendByte.Add((byte)TalkClient.EventType.DOWNLOADFILE);
