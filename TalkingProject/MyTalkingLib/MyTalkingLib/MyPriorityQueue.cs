...
namespace MyTalkingLib
{
    public class MyPriorityQueue
    {
        ...
        public void Enqueue(byte _oPriorityObject, List<byte> _Value)
        {
            ...
            {
                /*if (_oPriorityObject == (byte)EventType.INSERTTOSOCKETQUEUE)
                {
                    Console.WriteLine("PriorityMessage : " + MyConverter.GetStringFromByteArray(_Value.ToArray()));
                }*/
